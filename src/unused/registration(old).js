    ...
    try {
        ...
        do {
            ...
            if (additionalInputBox != null) {
                ...
                const course1FullErrorMessage = await webregPage.evaluate(
                    course1FullError => course1FullError.textContent,
                    course1FullError
                );
                // logs the failure
                console.log(
                    `Failed to register for course1: ${course1} or course2: ${course2}, with message: ${course1FullErrorMessage}.\nTrying again in ${timeout}...`
                );
                ...
                if (success) {
                    ...
                    console.log(
                        `Successfully registered for course1: ${course1} or course2: ${course2}, with message: ${successMessage}.`
                    );
                    ...
                    if (generalError) {
                        ...
                        console.log(
                            `Failed to register for course1: ${course1} or course2: ${course2}, with message: ${generalErrorMessage}.\nTrying again in ${timeout}...`
                        );
                        await webregPage.waitFor(timeout);
                    } else {
                        console.log(
                            `Failed to register for course1: ${course1} or course2: ${course2}, Due to unknown error.\nTrying again in ${timeout}...`
                        );
                        await webregPage.screenshot({
